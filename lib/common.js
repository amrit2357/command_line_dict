    ...
    while(selected){
      switch (rand) {
        case 0 :
          ...
          wrd = wrd.join('');
          selected = false;
          console.log(colors.green('Hint :' + wrd))
          break;
        case 1 :
          // Definition of word
          if (!isEmpty(result.definition)) {
            var value = randWord(result.definition)
            console.log(colors.green('Hint : def' + value.text))
            selected = false
          }
          break;
        case 2 :
          ...
          if (!isEmpty(result.synonym)) {
            ...
            console.log(colors.green('Hint  sys: syn' + value))
            selected = false
          }
          break;
        ...
        case 3 :
          ...
          if (!isEmpty(result.antonym)) {
            ...
            console.log(colors.green('Hint : ant' + value))
            selected = false
          }
          break;
      }
